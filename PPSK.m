function [TransDec,TransObj,TransMSE,FixNewCenter] = PPSK(PopDec,Model)
    global Global;
    Mnum = Global.SerNum;
    Pnum = 3;
    CenterPoints = zeros([Mnum,Global.D]);
    for i = 1:Mnum
        A1 = Global.MultiR(Global.t-i).TrainData;
    ...
    LastPop = Global.MultiR(Global.t-1).OptimalPop;
   ...
   %% Generate New Population
    OldOldPop  = Global.MultiR(Global.t-2).OptimalPop;
